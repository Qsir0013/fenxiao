<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"E:\phpStudy\PHPTutorial\WWW\fen\public/../application/admin\view\pro\index.html";i:1532054878;s:73:"E:\phpStudy\PHPTutorial\WWW\fen\application\admin\view\public\header.html";i:1532054692;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
	...
	<div class="span12">
      <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            ...
            <a href="<?php echo url('Pro/add'); ?>"><span class="label label-info"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">添加</font></font></span> </div></a>
            ...
            <table class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">产品价格</font></font></th>
                  <th><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">浏览量</font></font></th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align:center;"><?php if($vo['banner'] == ''): ?><img style="width:30px" src="zwt.jpg"/><?php else: ?><img style="width:30px" src="/uploads/<?php echo $vo['banner']; ?>"/><?php endif; ?></td>
                  ...
                  <td style="text-align:center;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $vo['price']; ?></font></font></td>
				  ...
				  <td style="text-align:center;">
					<a href="<?php echo url('Pro/edit',['id'=>$vo['id']]); ?>"><button class="btn btn-primary btn-mini"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">修改</font></font></button></a>
					&nbsp;&nbsp;
					<a href="<?php echo url('Pro/del',['id'=>$vo['id']]); ?>"><button class="btn btn-danger btn-mini"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">删除</font></font></button></a>
				  </td>
                </tr>
