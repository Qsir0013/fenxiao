<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"E:\phpStudy\PHPTutorial\WWW\fen\public/../application/admin\view\agent\add.html";i:1532066890;s:73:"E:\phpStudy\PHPTutorial\WWW\fen\application\admin\view\public\header.html";i:1532054692;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
        ...
        <div class="widget-content nopadding">
          <form action="" method="post" class="form-horizontal" >
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="name" class="span11" placeholder="代理角色名称">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="discount" class="span11" placeholder="优惠折扣">
              </div>
            </div>
