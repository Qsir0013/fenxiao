<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"E:\phpStudy\PHPTutorial\WWW\fen\public/../application/admin\view\index\index.html";i:1531920591;s:73:"E:\phpStudy\PHPTutorial\WWW\fen\application\admin\view\public\header.html";i:1531970634;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i>菜单</a>
  <ul>
    <li class="submenu"> <a href="#"><i class="icon icon-leaf"></i> <span>产品管理</span></a>
      <ul>
        <li><a href="index2.html">产品列表</a></li>
      </ul>
    </li>
	...
	<li class="submenu"> <a href="#"><i class="icon icon-arrow-down"></i> <span>代理管理</span></a>
      <ul>
        <li><a href="index2.html">代理列表</a></li>
      </ul>
    </li>
  </ul>
</div>
